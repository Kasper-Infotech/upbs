...
import ManagerActiveTask from "./Component/Manager/ManagerTaskManagement/ManagerActiveTask.jsx";
...
export const router = createBrowserRouter([
   ...
   
    {
        ...
        {
          path:"leaveApplicationAccepted",element:<ManagerLeaveApplicationHRAccepted/> },
        {
          path:"leaveApplicationRejected",element:<ManagerLeaveApplicationHRRejected/> },
        {path:"city" ,element:<City/> },
        ...
        {path:"holiday" ,element:<LeaveCalendar/> },
        {
          path:"todaysAttendance",element:<ManagerTodaysAttendance/> },
        {path:"myAttendance" ,element:<Attendance/> },
